            ...
            <div class="col-xl-12 ">
                <form  action="" method="POST" class="shadow p-3">
                    <div class="row">
                        ...
                        <h4 class="text-center">Ajouter un Enseigants </h4>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6  col-sm-6 p-3">
                            ...
                            <input required type="text" name="photo" class="form-control" placeholder="Choisir la photo de l'enseignant" value="">
                        </div>                     
